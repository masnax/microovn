...
func WaitForDBState(ctx context.Context, s state.State, db *OvsdbSpec, dbState string, timeout int) error {
...
func AppCtl(ctx context.Context, s state.State, target string, args ...string) (string, error) {
...
// unchanged.
func ControllerCtl(ctx context.Context, s state.State, args ...string) (string, error) {
